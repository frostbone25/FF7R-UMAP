...
namespace UMapExporter
{
    public static class ImageProcessing
    {
        public static void CombineAlbedoWithAlpha(string originalAlbedoPath, string originalAlphaPath)
        {
            ...
            {
                ConsoleWriter.WriteErrorLine(string.Format("CombineAlbedoWithAlpha Failed! Exception occured! {0}", exception.Message));
            }
        }
        ...
        public static void ExtractPBRMaps(string originalPBRPath)
        {
            ...
            {
                ConsoleWriter.WriteErrorLine(string.Format("ExtractPBRMaps Failed! Exception occured! {0}", exception.Message));
            }
        }
        ...
        public static void RemixPBR_ForUnityHDRP(string originalPBRPath, string originalOcclusionPath = "")
        {
            ...
            {
                ConsoleWriter.WriteErrorLine(string.Format("RemixPBR_ForUnityHDRP Failed! Exception occured! {0}", exception.Message));
            }
        }
        ...
        public static void RemixPBR_ForUnityURP(string originalPBRPath, string originalOcclusionPath = "")
        {
            ...
            {
                ConsoleWriter.WriteErrorLine(string.Format("RemixPBR_ForUnityURP Failed! Exception occured! {0}", exception.Message));
            }
        }
        ...
        public static void RemixPBR_ForUnityBIRP(string originalPBRPath)
        {
            ...
            {
                ConsoleWriter.WriteErrorLine(string.Format("RemixPBR_ForUnityBIRP Failed! Exception occured! {0}", exception.Message));
            }
        }
    }
}
